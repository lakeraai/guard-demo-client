...
class AppConfig(Base):
    ...
    llm_embedding_base_url = Column(String, nullable=True)
    llm_api_version = Column(String, nullable=True)
    llm_embedding_api_version = Column(String, nullable=True)
    llm_model = Column(String, default="gpt-4o-mini")
    llm_embedding_model = Column(String, nullable=True)
